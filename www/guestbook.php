...
if (isset($_SESSION['user'])) {
    echo '<input type="text"  class="form-control" id="inputName" placeholder="' . $_SESSION['user']['fullname'] . '" disabled>';
...
<?php 
if (isset($_SESSION['user'])) {
    echo '<input type="email" class="form-control" id="inputEmail" placeholder="' . $_SESSION['user']['email'] . '" disabled>';
